...
/**
 * @fileOverview A flow for summarizing articles given a URL.
 *
...
const SummarizeArticleInputSchema = z.object({
  articleUrl: z
    .string()
    .url()
    .describe('The URL of the article to summarize.'),
});
...
const summarizeArticlePrompt = ai.definePrompt({
  ...
  prompt: `You are an expert summarizer.  Please provide a concise summary of the article at the following URL: {{{articleUrl}}}`,
});
